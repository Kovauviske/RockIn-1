...
private _playerCount = count((position player) nearObjects ["Man",8]);
if (_playerCount > 1) exitWith {hint "Peça para que outras pessoas se afastem do veículo ou da casa.";};
if (dialog) exitWith {};
